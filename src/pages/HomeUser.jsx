          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-1/2">
              <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200 h-full flex flex-col">
                ...
                <div className="flex flex-col sm:flex-row gap-3 mt-auto">
                  ...
                  className="flex-1 bg-green-600 hover:bg-green-700 text-white px-4 py-3 rounded-lg transition duration-300 flex items-center justify-center">
            ...
            <div className="lg:w-1/2 z-11" >
              <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200 h-full flex flex-col">
                ...
                <div className="flex-grow min-h-[400px] mt-4">
                  <motion.div
                  ...
                  >
                    {latitude !== null && longitude !== null ? (
                      <MapComponent latitude={latitude} longitude={longitude} locations={locais} />
                    ) : (
